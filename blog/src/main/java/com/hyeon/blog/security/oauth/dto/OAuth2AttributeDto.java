package com.hyeon.blog.security.oauth.dto;
...
public class OAuth2AttributeDto {
   ...
   * */
  private static OAuth2AttributeDto ofGoogle(
    String provider,
    String attributeKey,
    Map<String, Object> attributes
  ) {
   ...
   * */
  private static OAuth2AttributeDto ofKakao(
    String provider,
    String attributeKey,
    Map<String, Object> attributes
  ) {
    ...
    Map<String, Object> kakaoProfile = (Map<String, Object>) kakaoAccount.get(
      "profile"
    );
   ...
   * */
  private static OAuth2AttributeDto ofNaver(
    String provider,
    String attributeKey,
    Map<String, Object> attributes
  ) {
